...
MMEngine 已实现了训练和测试常用的[钩子](https://github.com/vbti-development/onedl-mmengine/blob/main/docs/zh_cn/tutorials/hook.md),
...
可以按照如下方式, 在训练或测试中配置并使用自定义的钩子. 不同钩子在同一位点的优先级可以参考[这里](https://github.com/vbti-development/onedl-mmengine/blob/main/docs/zh_cn/tutorials/hook.md#%E5%86%85%E7%BD%AE%E9%92%A9%E5%AD%90), 自定义钩子如果没有指定优先, 默认是 `NORMAL`.
...
默认的优化器构造器在[这里](https://github.com/vbti-development/onedl-mmengine/blob/main/mmengine/optim/optimizer/default_constructor.py#L19) 被实现, 它也可以用来作为新的优化器构造器的模板.
