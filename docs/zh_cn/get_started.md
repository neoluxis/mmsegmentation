...
MMSegmentation 可以在 Linux, Windows 和 macOS 系统上运行，并且需要安装 Python 3.10+、CUDA 11.8+ 和 PyTorch 2.0+
...
**步骤 0.** 使用 [MIM](https://github.com/open-mmlab/mim) 安装 [MMCV](https://github.com/vbti-development/onedl-mmcv)
...
```shell
pip install "onedl-mmsegmentation>=1.4.0"
```
...
```shell
mim download onedl-mmsegmentation --config pspnet_r50-d8_4xb2-40k_cityscapes-512x1024 --dest .
```
...
**步骤 1.** 使用 [MIM](https://github.com/open-mmlab/mim) 安装 [MMCV](https://github.com/vbti-development/onedl-mmcv)
...
我们提供了一个 [Dockerfile](https://github.com/vbti-development/onedl-mmsegmentation/blob/main/docker/Dockerfile) 来建立映像。确保您的 [docker 版本](https://docs.docker.com/engine/install/) >=19.03.
...
如果您在安装过程中遇到了其他问题，请第一时间查阅 [FAQ](notes/faq.md) 文件。如果没有找到答案，您也可以在 GitHub 上提出 [issue](https://github.com/vbti-development/onedl-mmsegmentation/issues/new/choose)
